 ...
 * Original file: /npm/@mediapipe/pose@0.2.1614566818/pose.js
 *
...
if("function"==typeof Object.setPrototypeOf)D=Object.setPrototypeOf;else{var E;a:{var fa={a:!0},ha={};try{ha.__proto__=fa;E=ha.a;break a}catch(a){}E=!1}D=E?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var ia=D;function F(){this.l=!1;this.h=null;this.j=void 0;this.g=1;this.s=this.m=0;this.i=null}function N(a){if(a.l)throw new TypeError("Generator is already running");a.l=!0}F.prototype.o=function(a){this.j=a};
function O(a,b){a.i={J:b,K:!0};a.g=a.m||a.s}F.prototype.return=function(a){this.i={return:a};this.g=this.s};function P(a,b,c){a.g=c;return{value:b}}function ja(a){this.g=new F;this.h=a}function ka(a,b){N(a.g);var c=a.g.h;if(c)return la(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.g.return);a.g.return(b);return U(a)}
...
function ya(a){for(var b=[],c=a.size(),d=0;d<c;++d){var f=a.get(d);b.push({x:f.x,y:f.y,z:f.z,visibility:f.hasVisibility?f.visibility:void 0})}return b}function za(a,b,c){this.graph=a;this.locateFile=b;this.g=c}za.prototype.toArrayBuffer=function(){return X(this,function b(){var c=this,d;return V(b,function(f){return 1==f.g?(c.graph.url?f=P(f,fetch(c.locateFile(c.graph.url,c.g)),3):(f.g=2,f=void 0),f):2!=f.g&&(d=f.j,d.body)?f.return(d.arrayBuffer()):f.return(new ArrayBuffer(0))})})};
function Aa(){return X(this,function b(){return V(b,function(c){switch(c.g){case 1:return c.m=2,P(c,WebAssembly.instantiate(ua),4);case 4:c.g=3;c.m=0;break;case 2:return c.m=0,c.i=null,c.return(!1);case 3:return c.return(!0)}})})}
function Y(a){this.h=a;this.listeners={};this.F={};this.B={};this.l=this.A=!0;this.o=Promise.resolve();this.locateFile=a&&a.locateFile||va;if("object"===typeof window)a=window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/";else if("undefined"!==typeof location)a=location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/";else throw Error("solutions can only be loaded on a web page or in a web worker");this.D=a}
Y.prototype.close=function(){this.i&&this.i.delete();return Promise.resolve()};
function Ba(a){return X(a,function c(){var d=this,f,k,e,g,h,l,m,t,r;return V(c,function(n){switch(n.g){case 1:f=d;if(!d.A)return n.return();wa("createMediapipeSolutionsWasm",{locateFile:d.locateFile});wa("createMediapipeSolutionsPackedAssets",{locateFile:d.locateFile});k=d.h.files||[];return P(n,Aa(),2);case 2:return e=n.j,P(n,Promise.all(k.map(function(q){return void 0===q.simd||q.simd&&e||!q.simd&&!e?xa(f.locateFile(q.url,f.D)):Promise.resolve()})),3);case 3:return g=window.createMediapipeSolutionsWasm,
h=window.createMediapipeSolutionsPackedAssets,P(n,g(h),4);case 4:return d.g=n.j,d.j=document.createElement("canvas"),d.g.canvas=d.j,d.g.createContext(d.j,!0,!0,{}),d.i=new d.g.SolutionWasm,l=new za(d.h.graph,d.locateFile,d.D),P(n,d.loadGraph(l),5);case 5:if(d.h.listeners)for(m=v(d.h.listeners),t=m.next();!t.done;t=m.next())r=t.value,Ca(d,r);d.A=!1;n.g=0}})})}
...
function Da(a){return X(a,function c(){var d=this,f,k,e,g,h;return V(c,function(l){if(!d.l)return l.return();f=d.j.getContext("webgl2");if(!f)return alert("Failed to create WebGL canvas context when passing video frame."),l.return();d.s=f;if(d.m){k=new d.g.GraphOptionChangeRequestList;e=v(d.m);for(g=e.next();!g.done;g=e.next())h=g.value,k.push_back(h);d.i.changeOptions(k);k.delete();d.m=void 0}d.l=!1;l.g=0})})}
Y.prototype.initialize=function(){return X(this,function b(){var c=this;return V(b,function(d){return 1==d.g?P(d,Ba(c),2):P(d,Da(c),0)})})};Y.prototype.loadGraph=function(a){return X(this,function c(){var d,f=this;return V(c,function(k){if(1==k.g)return P(k,a.toArrayBuffer(),2);d=k.j;f.i.loadGraph(d);k.g=0})})};
Y.prototype.send=function(a,b){return X(this,function d(){var f=this,k,e,g,h,l,m,t,r;return V(d,function(n){if(1==n.g){if(!f.h.inputs)return n.return();k=1E3*(b||performance.now());return P(n,f.o,2)}if(3!=n.g)return P(n,f.initialize(),3);e=new f.g.PacketDataList;g=v(Object.keys(a));for(h=g.next();!h.done;h=g.next())if(l=h.value,m=f.h.inputs[l]){a:{var q=a[l];switch(m.type){case "video":var p=f.F[m.stream];p||(p=new ta(f.g,f.s),f.F[m.stream]=p);0===p.i&&(p.i=p.g.createTexture());if(q instanceof HTMLVideoElement){var u=
q.videoWidth;var A=q.videoHeight}else q instanceof HTMLImageElement?(u=q.naturalWidth,A=q.naturalHeight):(u=q.width,A=q.height);A={glName:p.i,width:u,height:A};u=p.j;u.canvas.width=A.width;u.canvas.height=A.height;u.activeTexture(u.TEXTURE0);p.g.bindTexture2d(p.i);u.texImage2D(u.TEXTURE_2D,0,u.RGBA,u.RGBA,u.UNSIGNED_BYTE,q);p.g.bindTexture2d(0);p=A;break a;default:p={}}}t=p;r=m.stream;e.pushTexture2d(Object.assign(Object.assign({},t),{stream:r,timestamp:k}))}f.i.send(e);e.delete();n.g=0})})};
function Ea(a,b,c){if(c.isNumber())return c.getNumber();if(c.isRect())return c.getRect();if(c.isLandmarks())return c.getLandmarks();if(c.isLandmarksList())return c.getLandmarksList();if(c.isClassificationsList())return c.getClassificationsList();if(c.isObjectDetectionList())return c.getObjectDetectionList();if(c.isTexture2d()){var d=a.B[b];d||(d=new ta(a.g,a.s),a.B[b]=d);a=d;c=c.getTexture2d();b=a.j;if(void 0===a.l){d=sa(b,"\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }",
0);var f=sa(b,"\n  precision highp float;\n  varying vec2 vTex;\n  uniform sampler2D sampler0;\n  void main(){\n    gl_FragColor = texture2D(sampler0, vTex);\n  }",1),k=b.createProgram();b.attachShader(k,d);b.attachShader(k,f);b.linkProgram(k);if(!b.getProgramParameter(k,b.LINK_STATUS))throw Error("Could not compile WebGL program.\n\n"+b.getProgramInfoLog(k));d=a.l=k;b.useProgram(d);f=b.getUniformLocation(d,"sampler0");a.h={v:b.getAttribLocation(d,"aVertex"),u:b.getAttribLocation(d,"aTex"),L:f};a.o=
b.createBuffer();b.bindBuffer(b.ARRAY_BUFFER,a.o);b.enableVertexAttribArray(a.h.v);b.vertexAttribPointer(a.h.v,2,b.FLOAT,!1,0,0);b.bufferData(b.ARRAY_BUFFER,new Float32Array([-1,-1,-1,1,1,1,1,-1]),b.STATIC_DRAW);b.bindBuffer(b.ARRAY_BUFFER,null);a.m=b.createBuffer();b.bindBuffer(b.ARRAY_BUFFER,a.m);b.enableVertexAttribArray(a.h.u);b.vertexAttribPointer(a.h.u,2,b.FLOAT,!1,0,0);b.bufferData(b.ARRAY_BUFFER,new Float32Array([0,1,0,0,1,0,1,1]),b.STATIC_DRAW);b.bindBuffer(b.ARRAY_BUFFER,null);b.uniform1i(f,
0)}d=a.h;b.useProgram(a.l);b.canvas.width=c.width;b.canvas.height=c.height;b.viewport(0,0,c.width,c.height);b.activeTexture(b.TEXTURE0);a.g.bindTexture2d(c.glName);b.enableVertexAttribArray(d.v);b.bindBuffer(b.ARRAY_BUFFER,a.o);b.vertexAttribPointer(d.v,2,b.FLOAT,!1,0,0);b.enableVertexAttribArray(d.u);b.bindBuffer(b.ARRAY_BUFFER,a.m);b.vertexAttribPointer(d.u,2,b.FLOAT,!1,0,0);b.bindFramebuffer(b.DRAW_FRAMEBUFFER,null);b.drawArrays(b.TRIANGLE_FAN,0,4);b.disableVertexAttribArray(d.v);b.disableVertexAttribArray(d.u);
b.bindBuffer(b.ARRAY_BUFFER,null);a.g.bindTexture2d(0);return a.j.canvas}}
function Ca(a,b){for(var c=b.name||"$",d=[].concat(da(b.wants)),f=new a.g.StringList,k=v(b.wants),e=k.next();!e.done;e=k.next())f.push_back(e.value);k=a.g.PacketListener.implement({onResults:function(g){return X(a,function l(){var m,t,r=this,n,q;return V(l,function(p){if(1==p.g){m={};for(t=0;t<b.wants.length;++t)m[d[t]]=Ea(r,b.wants[t],g.get(t));if(b.outs){for(var u=m,A=b.outs,G={},ma=v(Object.keys(A)),w=ma.next();!w.done;w=ma.next()){w=w.value;var B=A[w];if("string"===typeof B)G[w]=u[B];else{var H=
u[B.stream];if(void 0!==H){if("landmarks"===B.type)G[w]=ya(H);else if("landmarks_list"===B.type){for(var I=[],Q=H.size(),x=0;x<Q;++x){var J=H.get(x);I.push(ya(J))}G[w]=I}else if("classifications_list"===B.type){I=[];Q=H.size();for(x=0;x<Q;++x){var L=H.get(x);J=I;for(var ba=J.push,S=[],T=L.size(),M=0;M<T;++M){var R=L.get(M);S.push({index:R.index,score:R.score,label:R.label})}ba.call(J,S)}G[w]=I}else if("object_detection_list"===B.type){I=[];Q=H.size();for(x=0;x<Q;++x){L=H.get(x);J=I;ba=J.push;S=L.id;
T=L.keypoints;M=[];R=T.size();for(var ca=0;ca<R;++ca){var K=T.get(ca);M.push({id:K.id,point3d:{x:K.point3d.x,y:K.point3d.y,z:K.point3d.z},point2d:{x:K.point2d.x,y:K.point2d.y,depth:K.point2d.depth}})}ba.call(J,{id:S,keypoints:M,visibility:L.visibility})}G[w]=I}else throw Error("Unknown output config type: '"+B.type+"'");B.transform&&(G[w]=B.transform(G[w]))}}}m=G}(n=r.listeners[c])?p=P(p,r.o,3):(p.g=0,p=void 0);return p}if(q=n(m))return r.o=q,p.return(q);p.g=0})})}});a.i.attachMultiListener(f,k);
f.delete()}Y.prototype.onResults=function(a,b){this.listeners[b||"$"]=a};W("Solution",Y);W("OptionType",{NUMBER:0,BOOL:1,0:"NUMBER",1:"BOOL"});function Z(a){a=a||{};this.g=new Y({locateFile:a.locateFile,files:[{url:"pose_solution_packed_assets_loader.js"},{simd:!1,url:"pose_solution_wasm_bin.js"},{simd:!0,url:"pose_solution_simd_wasm_bin.js"}],graph:{url:"pose_web.binarypb"},listeners:[{wants:["pose_landmarks","image_transformed"],outs:{image:"image_transformed",poseLandmarks:{type:"landmarks",stream:"pose_landmarks"}}}],inputs:{image:{type:"video",stream:"input_frames_gpu"}},options:{selfieMode:{type:1,graphOptionXref:{calculatorType:"GlScalerCalculator",
calculatorIndex:1,fieldName:"flip_horizontal"}},upperBodyOnly:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorUpperBodyOnly",fieldName:"bool_value"}},smoothLandmarks:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorSmoothLandmarks",fieldName:"bool_value"}},minDetectionConfidence:{type:0,graphOptionXref:{calculatorType:"TensorsToDetectionsCalculator",calculatorName:"poselandmarkgpu__posedetectiongpu__TensorsToDetectionsCalculator",
fieldName:"min_score_thresh"}},minTrackingConfidence:{type:0,graphOptionXref:{calculatorType:"ThresholdingCalculator",calculatorName:"poselandmarkgpu__poselandmarkbyroigpu__ThresholdingCalculator",fieldName:"threshold"}}}})}Z.prototype.close=function(){this.g.close();return Promise.resolve()};Z.prototype.onResults=function(a){this.g.onResults(a)};Z.prototype.initialize=function(){return X(this,function b(){var c=this;return V(b,function(d){return P(d,c.g.initialize(),0)})})};
Z.prototype.send=function(a,b){return X(this,function d(){var f=this;return V(d,function(k){return P(k,f.g.send(a,b),0)})})};Z.prototype.setOptions=function(a){this.g.setOptions(a)};W("Pose",Z);W("POSE_CONNECTIONS",[[0,1],[1,2],[2,3],[3,7],[0,4],[4,5],[5,6],[6,8],[9,10],[11,12],[11,13],[13,15],[15,17],[15,19],[15,21],[17,19],[12,14],[14,16],[16,18],[16,20],[16,22],[18,20],[11,23],[12,24],[23,24],[23,25],[24,26],[25,27],[26,28],[27,29],[28,30],[29,31],[30,32],[27,31],[28,32]]);
