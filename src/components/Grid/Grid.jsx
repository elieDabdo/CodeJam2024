...
import "./Grid.scss";
import YogaVideo from "../../assets/mp4";
...
const Grid = () => {
  const presets = [
    {
      pictureUrl:
        "https://as1.ftcdn.net/v2/jpg/05/11/84/12/1000_F_511841276_7MyhimdVvJUi5sftZiCRtaIUMG2siF6t.jpg",
      title: "Yoga",
      video: YogaVideo,
    },
    {
      pictureUrl:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdOTtKr1QiIWs7JpNhAm7qkUeF47ddjsv8pw&usqp=CAU",
      title: "Tai Chi",
      video: TaiChiVideo,
    },
    {
    ...
    {
      pictureUrl:
        "https://www.shutterstock.com/image-photo/full-length-excited-funny-young-260nw-1967652817.jpg",
      title: "Dancing",
      video: DancingVideo,
    },
    {
